...
#ifndef OKCORE_SWIFT_H
#define OKCORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OkCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6OkCore14OkHiAppContext")
...
SWIFT_CLASS("_TtC6OkCore11OkHiAppMeta")
...
SWIFT_CLASS("_TtC6OkCore8OkHiAuth")
...
SWIFT_CLASS("_TtC6OkCore8OkHiCore")
@interface OkHiCore : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
